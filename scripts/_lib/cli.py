"""scripts/_lib/cli.py — shared scaffolding for the `TaiAi-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("TaiAi-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/TaiAi-foo`
...
VERSION = "0.1.0"  # bumped centrally; every TaiAi-* CLI reports this
