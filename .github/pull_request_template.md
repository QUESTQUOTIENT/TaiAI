...
- [ ] I searched [open issues](https://github.com/TieAI-archdaemon/TaiAi/issues) and [open PRs](https://github.com/TieAI-archdaemon/TaiAi/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses TaiAi's existing visual language. Specifically:
