...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'TaiAi-model-expanded',
  MODEL_ENDPOINTS: 'TaiAi-model-endpoints',
  MODEL_SELECTED: 'TaiAi-selected-model',
  SORT_ORDER: 'TaiAi-sessions-sort',
  CHAT_SEARCH_SCOPE: 'TaiAi-search-scope',
  INCOGNITO: 'TaiAi-incognito',
  RAG_ACTIVE: 'TaiAi-rag-active',
  MCP_ACTIVE: 'TaiAi-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'TaiAi-density',
  WORKSPACE: 'TaiAi-workspace',
  LAYOUT_FLIPPED: 'TaiAi-layout-flipped'
};
