...
const _ACTION_RECENTS_KEY = 'TaiAi-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'TaiAi-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'TaiAi' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
