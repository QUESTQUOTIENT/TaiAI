...
function initMermaid() {
  if (!window.mermaid || window.__TaiAiMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__TaiAiMermaidReady = true;
}
window.TaiAiInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'TaiAi-thinking-expanded';
