"""`TaiAi-research list --status complete` was returning nothing.
...
Part of #2122 (TaiAi-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "TaiAi-research"
    loader = importlib.machinery.SourceFileLoader("TaiAi_research_cli", str(path))
