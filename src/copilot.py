...
COPILOT_USER_AGENT = os.environ.get(
    "TaiAi_COPILOT_USER_AGENT", "TaiAi/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "TaiAi_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "TaiAi_COPILOT_EDITOR_VERSION", "TaiAi/1.0"
)
